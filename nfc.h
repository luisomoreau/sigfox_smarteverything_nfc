...
public:
    ...
    NFC(DEVICE_TYPE dt, byte fd_pin, byte vout_pin, byte i2c_address = DEFAULT_I2C_ADDRESS);
    void detectI2cDevices();//Comes in handy when you accidentally changed the I²C address of the NFC.
    bool begin();
...
private:
    ...
    static const byte NFC_BLOCK_SIZE=16;
